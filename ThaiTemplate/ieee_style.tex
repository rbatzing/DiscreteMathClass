...
%        1         2         3         4         5         6         7         8
\documentclass[a4paper, 12pt, conference]{ieeeconf}      \IEEEoverridecommandlockouts                              % This command is only
...
\title{\LARGE \bf
Preparation of Papers for IEEE Sponsored Conferences}
...
\begin{equation}
\label{taylorseries}
e^x = {x^0\over 0!} + {x^1\over 1!} + {x^1\over 1!} +{x^1\over 1!} +{x^1\over 1!} + ...= \sum^\infty_{n=0}\ {x^n\over n!}
\end{equation}
...
Kwong\cite{Kwong:2015} & 307\\
Levin\cite{Levin:2017} & 345 \\
Stein et als\cite{Stein:2011} & 526\\
สมชาย~ประสิทธิ์จูตระกูล\cite{Somchai:2011} & 339 \\
\end{tabular}
\end{center}
\end{table}
...
he example given in Algorithm~\ref{euclid} illustrates the Euclidean algorithm for determining the greatest common divisor dates back to 300BC.
